...
from SimplyTransport.api_contracts.map_contracts import RouteSummary
...
class RouteRepo(SQLAlchemyAsyncRepository[RouteModel]):  # type: ignore
    """Route repository."""
...
async def provide_route_repo(
    ...
    return RouteRepo(session=db_session, cache=redis_service)
