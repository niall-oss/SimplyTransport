...
if TYPE_CHECKING:
    from ..calendar_dates.calendar_date_model import CalendarDateModel
...
from ..calendar_dates.calendar_date_model import CalendarDateModel as CalendarDateModel  # noqa: E402
