...
from SimplyTransport.domain.database_statistics.database_statistic_model import DatabaseStatisticModel
...
from SimplyTransport.domain.shape.shape_model import ShapeModel
from SimplyTransport.domain.stop.stop_model import StopModel
from SimplyTransport.domain.stop_features.stop_feature_model import StopFeatureModel
...
class DatabaseStatisticRepo(SQLAlchemyAsyncRepository[DatabaseStatisticModel]):  # type: ignore
...
) -> DatabaseStatisticRepo:
    """This provides the Database Statistic repository."""

    return DatabaseStatisticRepo(session=db_session)
